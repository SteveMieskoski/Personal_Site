define(['require', 'jquery', 'store', 'TWEEN', 'scripts/runCreateOrDestroy'], function (require, $, store, TWEEN, runCreateOrDestroy) {
    ...
    tweenAnimate.prototype = {
        ...
        Run: function (objects, targets, scene, camera, renderer, duration, tweenRate, keepId, incrementStop, cb) {
            ...
            runCreateOrDestroy = require('./runCreateOrDestroy');
            counter = 0;
