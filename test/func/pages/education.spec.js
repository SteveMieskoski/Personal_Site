...
describe('Education page should', function () {
    var rerun = 2;
    browser.url('/');

    it('be accessed by clicking MainPage Education panel', function(){
        browser.click('.element:nth-Child(6)');
    ...
    it.skip('should have the right title', function () {
        ...
        assert.equal(title, 'Steve Mieskoski: Education');
    }, rerun );

    it('display background template html content', function () {
        var value = browser.getText('h2*=EDUCATION');
